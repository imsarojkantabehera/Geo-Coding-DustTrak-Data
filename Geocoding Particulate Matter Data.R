...
GPS <- st_read("GPS_Data.gpx", layer = "track_points")
...
# Assuming PM and GPS are your data frames and 'num_time' is the column to match
merged_data <- merge(PM, GPS, by = "num_time", all = TRUE)
...
write.csv(Final_Merged_Data, "Geocoded_PM_Data.csv", row.names = FALSE)
